  ...
  return (
    <>
      <button
        ...
        className="group pointer-events-auto flex flex-col items-center gap-3 rounded-3xl border border-white/40 bg-white/40 px-12 py-10 shadow-xl backdrop-blur-xl transition hover:bg-white/60"
      >
        <div className="grid h-16 w-16 place-items-center rounded-2xl bg-gradient-to-br from-sky-400 to-blue-600 text-white shadow-md">
          <Upload className="h-8 w-8" />
        </div>
        <div className="text-center">
          <p className="text-base font-semibold text-zinc-900">ZIP hierher ziehen</p>
          <p className="mt-1 text-xs text-zinc-600">oder klicken zum Auswählen</p>
        </div>
      </button>
      <input
        ref={inputRef}
